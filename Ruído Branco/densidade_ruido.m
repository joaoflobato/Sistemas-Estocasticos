...
realizacoes_ruido_branco = realizacoes_ruido_branco(:,1:n_amostras);

correlacao_forcamentos = 1/qtd_realizacoes*(realizacoes_ruido_branco'*realizacoes_ruido_branco);
