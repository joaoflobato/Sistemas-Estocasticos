...
realizacoes_ruido_Wiener = realizacoes_ruido_Wiener(:,1:n_amostras);

correlacao_forcamentos = 1/qtd_realizacoes*(realizacoes_ruido_Wiener'*realizacoes_ruido_Wiener);
