...
for i = 1:numel(fatores_amort)
    ...
    hold on
    grafico_medias = plot(intervalo,media_posicoes_norm,LineWidth=3);

    subplot(1,2,2)

    hold on
    grafico_dp = plot(intervalo,desvio_padrao_posicoes_norm,LineWidth=3);
...
ylabel("\mu_x / |\mu_{x_{max}}|",FontSize=20)

legend(legendas,Location="southeast",Orientation="horizontal")
...
set(gca,'fontsize',20)
xlabel("Tempo (s)",FontSize=20)
ylabel("\sigma_x / \sigma_{x_{max}}",FontSize=20)
