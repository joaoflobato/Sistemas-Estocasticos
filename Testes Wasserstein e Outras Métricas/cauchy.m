...
realizacoes_cauchy = tan(pi*(realizacoes_uniformes-1/2));

medias(n) = mean(realizacoes_cauchy);
...
cauchy_1 = tan(pi*(uniformes_1-1/2));
cauchy_2 = tan(pi*(uniformes_2-1/2));

dist_Wass(n) = distanciasWasserstein([cauchy_1;cauchy_2],2);
...
title(["Sample Mean Values";"of a Cauchy Variable"],FontSize=20)
...
title(["Sample Wasserstein Distances";"between Cauchy Variables"],FontSize=20)
xlabel("Sample Size",FontSize=20)
